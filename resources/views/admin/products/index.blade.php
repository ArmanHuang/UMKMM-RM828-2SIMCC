                                ...
                                @else
                                    @foreach ($products as $product)
                                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                            ...
                                            <td class="px-6 py-4">
                                                <a href="{{route('admin.products.product-images.index', $product)}}" class="font-medium 
                                                text-green-600 dark:text-green-500 hover:underline ms-2">Images</a>
                                                
                                                <a href="{{route('admin.products.edit', $product)}}" class="font-medium 
                                                text-blue-600 dark:text-blue-500 hover:underline ms-2">Edit</a>

                                                <a x-data="{}" x-on:click.prevent="$dispatch('open-modal', 'confirm-product-category-deletion-{{$product->id}}')" class="font-medium text-red-600 dark:text-red-500 hover:underline ms-2">Delete</a>

                                                <x-modal name="confirm-product-category-deletion-{{$product->id}}" :show="$errors->productCategoryDeletion->isNotEmpty()" focusable>
